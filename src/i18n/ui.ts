...
export const ui = {
	en: {
		...
		"websites.content": "At The Genesis Labs, we specialize in crafting bespoke websites tailored to your brand's needs. Our approach combines aesthetic design with technical proficiency, ensuring your site is visually stunning, fast, and responsive across all devices.",
		...
		"seo.content": "The Genesis Lab's SEO services are designed to increase your website's visibility and drive organic traffic. We use a blend of the latest SEO strategies and techniques to improve your search engine rankings, focusing on both on-page and off-page optimization.",
		...
		"contact.send": "Send",
		"contact.confirmation": "Boom! Your message just landed in our inbox. We’ll be in touch soon.",
		"blog.title": "Blog",
	...
	it: {
		...
		"websites.content": "Da The Genesis Labs, siamo specializzati nella realizzazione di siti web su misura per le esigenze del tuo marchio. Il nostro approccio combina design estetico con competenza tecnica, garantendo che il tuo sito sia visivamente accattivante, veloce e reattivo su tutti i dispositivi.",
		...
		"contact.confirmation": "Boom! Il tuo messaggio è appena atterrato nella nostra casella di posta. Ti ricontatteremo al più presto!",
		"contact.send": "Invia",
		"blog.title": "Blog",
